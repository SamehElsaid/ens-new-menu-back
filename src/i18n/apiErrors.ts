...
export const ApiErrors = {
  ...
  phoneVerificationRequired: {
    en: "Please verify your phone number before logging in",
    ar: "يرجى التحقق من رقم الهاتف قبل تسجيل الدخول",
  },
  ...
  phoneAlreadyVerified: {
    en: "Phone number is already verified",
    ar: "رقم الهاتف مفعّل مسبقًا",
  },
  failedVerifyPhone: {
    en: "Failed to verify phone number",
    ar: "فشل التحقق من رقم الهاتف",
  },
  failedResendPhoneVerification: {
    en: "Failed to resend WhatsApp verification code",
    ar: "فشل إعادة إرسال رمز التحقق عبر واتساب",
  },
  wawpNotConfigured: {
    en: "WhatsApp verification service is not configured",
    ar: "خدمة التحقق عبر واتساب غير مهيأة",
  },
  failedAddPhone: {
    en: "Failed to save phone number",
    ar: "فشل حفظ رقم الهاتف",
  },
